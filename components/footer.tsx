    ...
    <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <div class="mt-5 flex justify-center">
        <a class="text-base leading-6 text-gray-500">
          © 2022 Recap Time Squad, with some code from Denosaurs
        </a>
      </div>
      <div class="mt-5 flex justify-center">
        <a
          href="https://github.com/RecapTime"
        ...
        <a
          href="https://recaptime.pagelink/discord"
        ...
        <a
          href="https://twitter.com/RecapTime"
          class="ml-6 text-gray-400 hover:text-gray-500"
        >
